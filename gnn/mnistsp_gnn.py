...
class MNISTSPNet(torch.nn.Module):
    ...
    def __init__(self, in_channels, num_classes=10, n_train_data=None, args=None):
        ...
        self.structure_model = CosineLSM(in_channels, args.channels, args.dropout, args.neg_ratio)
